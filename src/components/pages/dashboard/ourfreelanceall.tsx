...
export default function OurFreelances () {
  ...
  const deleteFreel = async (id: any) => {
    setLoading(true)
    const deleteFreelancePath = `${backEndPoints.COMMUNITY}/${id.toString()}`
                        ...
                        <form className="w-full">
                            ...
                            <div className="flex flex-wrap">
                                ...
                                <div className="w-full md:w-1/3 p-1">
                                    ...
                                    <input type="date" value={phone} onChange={(e: any) => setPhone(e.target.value)} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" />
                                </div>
                                <div className="w-full md:w-1/3 p-1">
                                ...
                                <div className="w-full md:w-1/3 p-1">
                                    ...
                                    <input type="text" value={projectname} onChange={(e: any) => setProjectname(e.target.value)} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" />
                                </div>
                                <div className="w-full md:w-1/3 p-1">
                                    <label htmlFor="name" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Email</label>
                                    <input type="text" value={workduration} onChange={(e: any) => setWorkduration(e.target.value)} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" />
                                </div>
                                <div className="w-full md:w-1/3 p-1">
                                    <label htmlFor="name" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">StartDate</label>
                                    <input type="file" value={summary} onChange={(e: any) => setSummary(e.target.value)} className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" />
                                </div>
                            </div>
            ...
            <div className="p-2">
                <div className="flex flex-wrap">
                    <div className="w-full flex flex-wrap py-4 bd-gray-100 border-b-2 border-gray-600 my-2">
                        <div className="w-1/2">
                            <h2 className="font-bold">Our Freelance</h2>
                        </div>
                    </div>
