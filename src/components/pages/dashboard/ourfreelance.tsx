...
import OurFreelances from './ourfreelanceall'
import { backEndPoints } from '../../utils/enum'
import api from '../../utils/endpointRequest'
export default function OurFreelanceHome () {
  ...
  return (
        <>
            <div className="w-full flex justify-end mt-5">
                <a href="/addfreelance">
                    <button className="bg-yellow-500 hover:bg-blue-400 px-8 py-2 text-white font-bold rounded-full ml-12 mr-12"><i className="fa fa-plus  text-white font-bold px-2"></i>Add New</button>
                </a>
            </div>
            <div className="pt-12 text-black px-4 text-2xl font-bold">Our Freelance</div>
                        ...
                        <div className="flex-auto p-4">
                            <div className="flex flex-wrap">
                                <div className="relative w-full pr-4 max-w-full flex-grow flex-1">
                                    <h5 className="text-gray-100 uppercase font-bold text-xs">All freelancer</h5>
